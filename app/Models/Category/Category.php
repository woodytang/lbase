...
class Category extends Node {
  ...
  protected $table = 'categories';
    protected $guarded = array('id', 'lft', 'parent_id','rgt', 'depth');

    public static function pack($name, $alias,$type,$description)
    {
        $postObj = new static (compact('name','alias','type','description'));
