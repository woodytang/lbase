...
<div class="row add-border-bottom">
    <div class="col-md-12 m-b-20">
        <h3>标签：<span class="semi-bold">{{$tag->name}}</span></h3>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12 m-b-10">
                <div class="widget-item ">
                    ...
                    <div class="tiles purple " style="max-height:345px; min-height: 230px;">
                        <div class="tiles-body">

                            <div class="overlayer-wrapper">
                                <div class=" p-l-10 p-b-10 p-t-10">
                                    <div class="pull-right"> <a href="#" class="hashtags transparent"> #{{$post->category->name}}</a> </div>
