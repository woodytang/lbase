...
<div class="row add-border-bottom">
    <div class="col-md-12 m-b-20">
        <h3>搜索：<span class="semi-bold color-red">{{$query}}</span> &nbsp;&nbsp;&nbsp;&nbsp;<small>共找到{{$counts}}条结果</small></h3>
    </div>
                        ...
                        <div class="tiles-body">
                            ...
                            <div class="overlayer-wrapper">
                                <div class=" p-l-10 p-b-10 p-t-10">
                                    <div class="pull-right"> <a href="#" class="hashtags transparent"> #{{isset($post->category->name)?$post->category->name:'未分类'}}</a> </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            <a href="{{route('post_path',[$post->id])}}">
                            <h3 class="text-white m-t-10 m-b-30 "> <span class="semi-bold">{{$post->title}} </h3></a>
