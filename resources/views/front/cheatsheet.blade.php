...
<link rel="stylesheet" href="/front/cheatsheet/assets/css/normalize.css" />
<link rel="stylesheet" href="/front/cheatsheet/assets/css/foundation.min.css" />
<link rel="stylesheet" href="/front/cheatsheet/assets/css/font-awesome.min.css" />
<link rel="stylesheet" href="/front/cheatsheet/assets/css/page.css" />
...
<style type="text/css">
    ...
    .site_container {background-color: #a289bf;}

    pre {
        border: 1px solid #A289BF;
    }
...
<div class="row">
    ...
    <div class="col-md-4 ">
        ...
        <div class="well well-small">
            <h5 class="semi-bold">注意</h5>以下内容适用于Laravel 4，但未升级到Laravel 5，请酌情参考。
        </div>
    </div>
</div>
...
@section('custom_js')
 ...
 <script type="text/javascript">
    $(document).ready(function () {
        ...
        $.get("/front/cheatsheet/assets/js/jquery-2.1.1.js");
        $.get("/front/cheatsheet/assets/js/foundation.min.js");
        $.get("/front/cheatsheet/assets/js/google-code-prettify/prettify.js");
        $.get("/front/cheatsheet/assets/js/app.js");
...
<!--<script src="/front/cheatsheet/assets/js/jquery-2.1.1.js"></script>

<script src="/front/cheatsheet/assets/js/jquery.highlight-4.js"></script>
<script src="/front/cheatsheet/assets/js/foundation.min.js"></script>
<script src="/front/cheatsheet/assets/js/google-code-prettify/prettify.js"></script>
<script src="/front/cheatsheet/assets/js/app.js"></script>-->
