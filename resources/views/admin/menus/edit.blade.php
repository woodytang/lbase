...
<input type="hidden" id="2" value="<?php echo $menu->parent_id ?>" />
            ...
            <div class="row" >
                    ...
                    <form  method="get" action="{!!route('admin.menus.index')!!}">
                        ...
                        <div class="form-group">
                            ...
                            <select  id="menu_set" style="width: 37%" data-init-plugin="select2"
                                ...
                                <option value="{{$menuset->id}}">{{$menuset->name}}</option>
                ...
                <div class="col-md-2 ">
                    <div class="cs-wrapper m-l-50">
                        <a href="{!!route('admin.menusets.index')!!}">
    ...
    <div class="col-md-4">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form role="form" method="post" action="{!! route('admin.menus.update',[$menu->id])!!}">
                    <input name="_method" type="hidden" value="PUT">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <input id="set_id" type="hidden" name="menuset_id" value="{{ $set_id }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="text" class="form-control" name="link" value="{{$menu_link}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id ='parent_id' class="full-width" data-init-plugin="select2" name="parent_id">
                            ...
                            @foreach($menu->getDescendantsAndSelf(array('id','parent_id','name','depth'))->toHierarchy()
                            as $relation)
                ...
                <div class="row-fluid">
                    <div class="span8">
                        ...
                        <table class="table table-bordered no-more-tables" id="menu_table">
                            ...
                            @if(isset($menus))
                            @foreach($menus as $menu)
                            @foreach($menu->getDescendantsAndSelf()->toHierarchy() as $relation)
                            <tr>
                                ...
                                <td class="text-left ">
                                    {{Config::get('app.url')}}<span class="text-danger bold">{{$relation->link}}</span>
                                </td>
                                ...
                                <td class="text-center ">
                                    ...
                                    <div class="row-fluid">
                                        ...
                                        <div class="col-xs-4">
                                            ...
                                            <form method="post"
                                                  action="{!! route('admin.menus.destroy',[$relation->id]) !!}"
                                                  type="button">
                                        ...
                                        <div class="col-xs-4">
                                            <a href="{!!route('admin.menus.edit',[$relation->id,'set_id'=>$set_id])!!}">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-4">
                                            ...
                                            <div class="pull-right">
                                                <a href="{!!url('/admin/api/movedown',$parameters =['id'=>$relation->id, 'model'=>'App\Models\Menu\Menu'])!!}">
                                                    <button class="btn btn-white btn-xs"><i class="fa fa-long-arrow-down"></i>&nbsp;&nbsp;&nbsp;向下移</button>
                                                </a>
                                            </div>
                                            <div class=" m-r-20 pull-right">
                                                <a href="{!!url('/admin/api/moveup',$parameters =['id'=>$relation->id, 'model'=>'App\Models\Menu\Menu'])!!}">
                                        ...
                                        <div class="col-xs-4">
                                            ...
                                            <div class="pull-right">
                                            <form method="get"
                                                  action="{!!url('/admin/api/movetopof',$parameters =['id'=>$relation->id, 'model'=>'App\Models\Menu\Menu'])!!}"
                                                  >
                                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                <div class="form-group">
                                                    <label>移动到</label>
                                        ...
                                        <div class="col-xs-4">
                                            <div class="pull-right">
                                            <form method="get"
                                                  action="{!!url('/admin/api/movebottomof',$parameters =['id'=>$relation->id, 'model'=>'App\Models\Menu\Menu'])!!}"
                                                >
                                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                <div class="form-group">
                                                    <label>移动到</label>
