    ...
    <div class="col-md-4">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4><span class="semi-bold">修改专辑</span></h4>
            </div>
            <div class="panel-body">

                <form role="form" method="POST" enctype="multipart/form-data"  action="{{route('admin.sections.update',[$section->id])}}">
                    <input name="_method" type="hidden" value="PUT">

                    <div class="form-group form-group-default">
                        <label class="label-lg">输入专辑名称</label>
                        <input type="text" placeholder="" class="form-control input-lg" name="name" value="{{$section->name}}">
                    </div>

                    <div class="form-group">
                        <label class="label-lg">输入专辑描述</label>
                        <textarea  placeholder="输入文字" class="form-control" rows="8"
                                   name="description">{{$section->description}}</textarea>
                    </div>

                    <div class=" form-group">

                        <img src="<?= $section->cover->url('medium') ?>" width = "300px">
