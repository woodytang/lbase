<head>
    ...
    <link class="main-stylesheet" href="/assets/pages/css/themes/abstract.css" rel="stylesheet" type="text/css" />
    <!--[if lte IE 9]>
    <link href="/assets/pages/css/ie9.css" rel="stylesheet" type="text/css" />
    <![endif]-->
     <!--Amaran JS 消息提醒-->
     <link rel="stylesheet" href="/assets/AmaranJS/css/amaran.min.css">
    <link type="text/css" rel="stylesheet" href="/assets/assets/plugins/bootstrap-tag/jquery.tagsinput.min.css">
    @yield('custom_css')
    <link class="main-stylesheet" href="/assets/pages/css/reset.css" rel="stylesheet" type="text/css" />
