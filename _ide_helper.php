...
namespace {
    ...
    class Amaran extends \Xuma\Amaran\Facades\Amaran{
        ...
        public static function create(){
            return \Xuma\Amaran\AmaranHandler::create();
        }
        ...
        public static function theme($theme = 'default'){
            return \Xuma\Amaran\AmaranHandler::theme($theme);
        }
         ...
         * @static 
         */
        public static function position($position = 'bottom right'){
            return \Xuma\Amaran\AmaranHandler::position($position);
        }
        ...
        public static function content($content){
            return \Xuma\Amaran\AmaranHandler::content($content);
        }
         ...
         * @static 
         */
        public static function inEffect($ineffect){
            return \Xuma\Amaran\AmaranHandler::inEffect($ineffect);
        }
        ...
        public static function sticky(){
            return \Xuma\Amaran\AmaranHandler::sticky();
        }
         ...
         * @static 
         */
        public static function outEffect($outEffect){
            return \Xuma\Amaran\AmaranHandler::outEffect($outEffect);
        }
        ...
        public static function flash(){
            return \Xuma\Amaran\AmaranHandler::flash();
        }
         ...
         * @static 
         */
        public static function bind($element = false, $on = 'click'){
            return \Xuma\Amaran\AmaranHandler::bind($element, $on);
        }
        
    }


    class Settings extends \Offline\Settings\Facades\Settings{
         ...
         */
        public static function get($key, $default = null){
            return \Offline\Settings\Settings::get($key, $default);
        }
        ...
        public static function hasKey($key){
            return \Offline\Settings\Settings::hasKey($key);
        }
        ...
        public static function set($key, $value){
            return \Offline\Settings\Settings::set($key, $value);
        }
         ...
         */
        public static function forget($key){
            \Offline\Settings\Settings::forget($key);
        }
         ...
         */
        public static function flush(){
            return \Offline\Settings\Settings::flush();
        }
        ...
        public static function getAll(){
            return \Offline\Settings\Settings::getAll();
        }
